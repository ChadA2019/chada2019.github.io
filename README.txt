CHAD'S FINANCE MANAGER V3.3

V3.3 TRUE DROPDOWN FIX
- Category is now a true dropdown instead of a text field with suggestions.
- All categories are visible immediately when the dropdown is tapped.
- Subcategory updates automatically when Category changes.
- Asset is also now a true dropdown.

V3.2 REVIEW QUEUE IMPROVEMENT
- Added a proper Subcategory dropdown in the Review Queue.
- Subcategory choices update automatically when the selected Category changes.
- Existing custom subcategories are preserved.
